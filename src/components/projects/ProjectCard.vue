...
<template>
  ...
  >
    <div class="overflow-hidden relative transition-all duration-150 ease-in-out">
      <ImageSrcSet v-if="card.imgSrcSet" :img="card.imgSrcSet" :class="[isHovered ? 'scale-105' : 'scale-100' , 'w-full h-auto object-cover transition-all duration-300']" loading="lazy" />
    </div>  
