          ...
          <div class="text-center">
            ...
            <div class="flex gap-4 items-center justify-center py-4">
              <a href="https://www.linkedin.com/in/paz-spera/" target="_blank" rel="noopener noreferrer"
                aria-label="Linkedin de Paz Spera" class="p-1 text-primary-900 hover:text-primary-800 transition ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-700  active:text-primary-300 ">
              ...
              <a href="https://github.com/pazspera" target="_blank" rel="noopener noreferrer" aria-label="Github de Paz Spera" class="p-1 text-primary-900 hover:text-primary-800 transition ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-700  active:text-primary-300">
